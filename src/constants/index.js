...
export const benefits = [
  ...
  },
  {
    ...
    text: "A Rolex landing page built using #React and #Tailwind CSS. This project beautifully showcased my ability to develop sleek, interactive, and responsive web pages with modern design aesthetics.",
    iconUrl: github,
    img:rolex,
